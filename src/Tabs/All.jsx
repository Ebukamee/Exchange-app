      ...
      <Tabs.Root defaultValue="all" w="100%" my={10} variant="enclosed">
        ...
        <Tabs.Content value="all" p={20} py={0}>
          ...
          >
            ...
            <Text textAlign="center" mt={4} color='gray.700' fontSize="sm">No Transaction Record</Text>
          </Container>
        </Tabs.Content>
        <Tabs.Content value="pending" p={20} py={0}>
          ...
          >
            <Image src={No} alt="no transaction record" />
            <Text textAlign="center" mt={4} color='gray.700' fontSize="sm">No Pending Transaction Record</Text>
          </Container>
        </Tabs.Content>
        <Tabs.Content value="confirmed" p={20} py={0}>
          ...
          >
            <Image src={No} alt="no transaction record" />
            <Text textAlign="center" mt={4} color='gray.700' fontSize="sm">No Confirmed Transaction Record</Text>
          </Container>
        </Tabs.Content>
        <Tabs.Content value="rejected" p={20} py={0}>
          ...
          >
            <Image src={No} alt="no transaction record" />
            <Text textAlign="center" mt={4} color='gray.700' fontSize="sm">No Rejected Transaction Record</Text>
          </Container>
        </Tabs.Content>
      </Tabs.Root>
    </Box>
