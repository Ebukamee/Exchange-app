...
import TransactionTable from "./Tabs/TransactionsAdmin";
import GiftcardForm from "./Tabs/GiftcardTable";
    ...
    <>
      <Routes>
        ...
        <Route path="transactions" element={<TransactionTable />} />
          <Route path="/admin/dashboard/manage-giftcards" element={<GiftcardForm />} />
        </Route>
