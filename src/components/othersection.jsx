  ...
  const features = [
    {
      ...
      description: "Our skilled technicians deliver meticulous work with precision and attention to detail.",
      icon: (
    ...
    },
    {
      ...
      description: "We invest in the latest CAD/CAM systems and 3D printing technology for superior results.",
      icon: (
    ...
    },
    {
      ...
      description: "We partner with dental professionals to achieve optimal patient outcomes.",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
      ...
      description: "Your patients' satisfaction and well-being are at the heart of everything we do.",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-pink-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
      ...
      description: "Efficient workflows ensure timely delivery without compromising quality.",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
      ...
      description: "We operate with integrity, transparency, and the highest professional standards.",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-pink-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
        </svg>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="mt-4 text-xl text-gray-600">
            Discover the difference that precision, technology, and commitment make in dental laboratory services.
          </p>
        </div>
